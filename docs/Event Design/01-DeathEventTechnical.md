...
|District|Event Property|8 character code or "null" (lowercase)|Location of the district relating to the person’s primary residential address. https://www.tewhatuora.govt.nz/our-health-system/data-and-statistics/nz-health-statistics/data-references/code-tables/common-code-tables#district-health-board-code-table |
|Domicile|Event Property|4 character district code or "null" (lowercase)| Domicile code, representing a person’s primary residential address. https://fhir.org.nz/ig/base/CodeSystem-domicile-code.html |
|GP Practice|Event Property|8 character code or "null" (lowercase)|The active GP practice of the deceased healthcare user. https://www.tewhatuora.govt.nz/our-health-system/data-and-statistics/nz-health-statistics/data-references/code-tables/common-code-tables#facility-code-table **Note**: Not all healthcare users have a GP practice. Where no GP practice exists for the NHI, this field will be "**null**"|
